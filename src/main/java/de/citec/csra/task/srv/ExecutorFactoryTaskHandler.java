 ...
 * @author pholthau
 */
public class ExecutorFactoryTaskHandler extends AbstractTaskHandler {

	private final LocalTaskFactory builder;

	public ExecutorFactoryTaskHandler(LocalTaskFactory builder) {
