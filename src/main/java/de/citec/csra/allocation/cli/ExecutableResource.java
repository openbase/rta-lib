...
public abstract class ExecutableResource<T> implements SchedulerListener, Executable, Callable<T> {
    ...
    public ExecutableResource(ResourceAllocation allocation, Completion completion, ExecutorService executorService) {
    ...
    public ExecutableResource(String description, Policy policy, Priority priority, Initiator initiator, long delay, long duration, Completion completion, ExecutorService executorService, String... resources) {
